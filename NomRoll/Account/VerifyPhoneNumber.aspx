<%@ Page Title="Verify Phone Number" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="VerifyPhoneNumber.aspx.vb" Inherits="NomRoll.VerifyPhoneNumber" %>
